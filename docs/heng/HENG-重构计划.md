...
**当前规范引擎：16 条规则(11 强条) · 3 辖区(CN/EU/JP) · 2 域(建筑/水工) · 每条附算例(规范库CI全过) · 强条漏检数=0 · 玻璃盒四条成立。**
**当前套件：modeler 25 文件 + core+heng 46 文件(原30+钢结构+heng 15文件~72测试) 全绿；全部已开源同步 GitHub/Gitee。**
